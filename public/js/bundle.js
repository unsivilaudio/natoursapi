...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidW5zaXZpbCIsImEiOiJja2UzNGs5bDQwZmp3MnRtYXFpMHRiaWpzIn0.LuwfMa5qKtr0SUKi7OAalg';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            (0, _alert.showAlert)('success', 'Sucessfully logged in!');
            _context.next = 12;
            break;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            (0, _alert.showAlert)('success', 'Successfully updated user profile.');
            _context.next = 10;
            break;
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              button = document.querySelector('.btn--save-password');
              button.textContent = 'Updating...';
              password = document.getElementById('password-current');
              updatePassword = document.getElementById('password');
              updatePasswordConfirm = document.getElementById('password-confirm');
              _context.next = 8;
